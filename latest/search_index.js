...

{
    ...
    "title": "LP",
    "category": "section",
    "text": "Compared to the LP formulation (below), the MathOptFormat version is verbose and less human-readable. However, it does not require a specialized parser to read, conforms to a well standardized specification, and is extensible./ Author: Oscar Dowson\n/ Description: A simple example for the MathOptFormat documentation\nMinimize\nobj: 2x + y\nSubject To\nc1: x + y >= 1\nBounds\ny free\nBinary\nx\nEnd"
},
